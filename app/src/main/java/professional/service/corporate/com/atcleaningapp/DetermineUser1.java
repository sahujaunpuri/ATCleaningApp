...
public class DetermineUser1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if ((sharedPref1.getString(sharedPrefKey, "")).toLowerCase().equalsIgnoreCase("user")) {
            Intent i = new Intent(DetermineUser1.this, NavigationBarUser.class);
        ...
        if ((sharedPref1.getString(sharedPrefKey, "")).toLowerCase().equalsIgnoreCase("contractors")) {
            ...
            Intent i = new Intent(DetermineUser1.this, NavigationBarContractors.class);
