...
class AllBidsPostedAdapter extends ArrayAdapter< AllAvailableJobsClass> {
    ...
    public AllBidsPostedAdapter(ArrayList< AllAvailableJobsClass> objects, Context context) {
        super(context, R.layout.bids_page_list_row, objects);
    ...
    public View getView(final int position, final View convertView, final ViewGroup parent) {
        ...
        if (v == null) {
            ...
            v = inflater.inflate(R.layout.bids_page_list_row, null);
        }
        ...
        if (i != null) {
            ...
            if (availability!= null) {
                ...
                if(i.getAvailability().equalsIgnoreCase("Closed For Bidding")) {
                    availability.setText(i.getAvailability());
                    availability.setBackgroundColor(Color.BLUE);
                }
