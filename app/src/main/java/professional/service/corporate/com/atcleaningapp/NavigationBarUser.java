...
public class NavigationBarUser extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    TextView login;
    TextView signup;
    SessionManager sm;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.navigation_bar_user);
        ...
        changedp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(NavigationBarUser.this, UploadProfilePIc.class);
                startActivity(i);
                overridePendingTransition(R.anim.enter, R.anim.exit);
            }
        });

        Fragment fragment = new AllPostedJobs();
    ...
    private void displaySelectedScreen(int itemId) {
        ...
        switch (itemId) {
            ...
            case R.id.nav_dashboard:
                fragment = new AllPostedJobs();
                break;
            case R.id.nav_bid:
                fragment = new CreateBidJobPost();
                break;
            case R.id.nav_history:
                fragment = new CalendarHistory();
                break;
            case R.id.nav_apt:
                fragment = new MyAllBookings();
                break;

            case R.id.nav_pay_to:
                fragment = new MyAllBookings();
                break;
            case R.id.nav_transaction:
                fragment = new UserTransactions();
                break;
            case R.id.nav_logout:
                ...
                editor2.commit();
                finish();
                Intent intent = new Intent(NavigationBarUser.this, LoginActivity.class);
                ...
                if(s!=null) {
                    if (s.image != null) {
                        ...
                        if (s.gender.equalsIgnoreCase("Male")) {
                            Picasso.with(AppController.getAppContext()).load(R.drawable.male).fit().into(circleView);
                        }
                        if (s.gender.equalsIgnoreCase("Female")) {
                            Picasso.with(AppController.getAppContext()).load(R.drawable.female).fit().into(circleView);
                        }
                    }
            ...
            protected void onPostExecute(String s) {
                ...
                try {
                    ...
                    if (apiResponse.getInt("status") != 200) {
                        Toast.makeText(NavigationBarUser.this, apiResponse.getString("message"), Toast.LENGTH_SHORT).show();
                        return;
                    }
...
//executing the async task
    ...
    @Override
    public void onBackPressed() {
        AlertDialog.Builder builder = new AlertDialog.Builder(NavigationBarUser.this);
        builder.setMessage("Do You want to Leave this page?")
                .setCancelable(false)
                .setPositiveButton("Yes, I want to Go Back!", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        finish();
                        Intent i = new Intent(NavigationBarUser.this, NavigationBarUser.class);
                        startActivity(i);
                    }
                })
