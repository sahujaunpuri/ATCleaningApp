...
public class CompletedWorkAdapterEmployer extends ArrayAdapter< AllAvailableJobsClass> {
...
private ArrayList< AllAvailableJobsClass> objects;
        ...
        MilestonePaymentListener mpl;

public CompletedWorkAdapterEmployer(ArrayList< AllAvailableJobsClass> objects, Context context, AprroveAndRateListener aprl, MilestonePaymentListener mpl) {
...
public View getView(final int position, final View convertView, final ViewGroup parent) {
        ...
        // These TextViews are created in the XML files we defined.
            ...
            if (rate_feedback!= null) {
                ...
                rate_feedback.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                                int project_id = i.getId();
                                int assignee_id = i.getAssignee_id();
                                aprl.rateContractor(project_id, assignee_id);
                        }
                });
