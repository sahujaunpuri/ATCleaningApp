...
public class MyBookingsAdapter extends ArrayAdapter< BidsByContractirClass> {
    ...
    public MyBookingsAdapter(ArrayList< BidsByContractirClass> objects, Context context, final OnMarkFinishedListener onAcceptOrRejectButtonClick) {
        super(context, R.layout.todays_work_row_item, objects);
    ...
    public View getView(final int position, final View convertView, final ViewGroup parent) {
        ...
        if (v == null) {
            ...
            v = inflater.inflate(R.layout.todays_work_row_item, null);
