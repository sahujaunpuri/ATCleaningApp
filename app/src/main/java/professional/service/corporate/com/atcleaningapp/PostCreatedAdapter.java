...
public class PostCreatedAdapter extends ArrayAdapter< AllAvailableJobsClass> {
    ...
    public PostCreatedAdapter(ArrayList< AllAvailableJobsClass> objects, Context context) {
