...
public class CompletionRequest extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.completion_request_from_contractor, container, false);
        title_of_project = (TextView)view.findViewById(R.id.title_of_project);
        bid_amt = (TextView)view.findViewById(R.id.total_amt);
        approve_request = (TextView)view.findViewById(R.id.send_request);
    ...
    private void sendRequestToEmployer(final int project_id) {
        class RegisterUser extends AsyncTask<Void, Void, String> {
            ...
            protected String doInBackground(Void... voids) {
                ...
                try {
                    JSONObject response = requestHandler.sendPostRequest(URLs.URL_SEND_PROJECT_APPROVAL_REQUEST_TO_CONTRACTOR, params, Request.Method.POST);
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                dialog.setMessage("Approving Completion Of Project!");
                dialog.show();
            }
            ...
            protected void onPostExecute(String s) {
                ...
                Fragment fragment = new MyAllBookings();
    ...
    private void getProjectDetails() {
        ...
        class RegisterUser extends AsyncTask<Void, Void, AllAvailableJobsClass> {
            ...
            protected AllAvailableJobsClass doInBackground(Void... voids) {
                ...
                HashMap<String, String> params = new HashMap<>();
                int current_project = project_id;
                int current_bidder = assignee_id;
                params.put("project_id", String.valueOf(current_project));
